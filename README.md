...
1) Customer
    ~~~json
    { 
    "_id" : ObjectId("628df5abe052afd4b7931c3e"), 
    "auth" : {
        "login" : "user2", 
        "password" : "$2a$10$.oG16HYm5EQcqhzeHm55cO1gHdbXd79s1evcI0yp8xLRZa3Yssc8q"
    }, 
    "name" : "user2", 
    "createdAt" : ISODate("2022-05-25T09:23:55.928+0000"), 
    "updatedAt" : ISODate("2022-05-25T09:23:55.928+0000"), 
    "__v" : NumberInt(0)
}
...
4) Transactions
   ~~~json
   { 
    "_id" : ObjectId("628e0efe7b7995234486c801"), 
    ...
    "products" : [
        {
            ...
            "count" : NumberInt(30), 
            "_id" : ObjectId("628dfe097b7995234486c787")
        }, 
        {
            "productName" : "Marchewki", 
            "seller_id" : "628dfbda6387e5c9a32b6b55", 
            "count" : NumberInt(8), 
            "_id" : ObjectId("628dfee97b7995234486c78a")
        }, 
        {
            "productName" : "Czereśnie", 
            "seller_id" : "628dfbda6387e5c9a32b6b55", 
            "count" : NumberInt(3), 
            "_id" : ObjectId("628dff007b7995234486c78c")
        }, 
        {
            "productName" : "Truskawki", 
            "seller_id" : "628dfac86387e5c9a32b6b45", 
            "count" : NumberInt(25), 
            "_id" : ObjectId("628e00587b7995234486c797")
        }, 
        {
            "productName" : "Marchewki", 
            "seller_id" : "628dfac86387e5c9a32b6b45", 
            "count" : NumberInt(15), 
            "_id" : ObjectId("628e006c7b7995234486c799")
        }, 
        {
            "productName" : "Jabłka", 
            "seller_id" : "628dfac86387e5c9a32b6b45", 
            "count" : NumberInt(100), 
            "_id" : ObjectId("628e007c7b7995234486c79b")
        }, 
        {
            "productName" : "Jajka", 
            "seller_id" : "628dfac86387e5c9a32b6b45", 
            "count" : NumberInt(12), 
            "_id" : ObjectId("628e008b7b7995234486c79d")
        }, 
        {
            "productName" : "Pietruszki", 
            "seller_id" : "628dfbb36387e5c9a32b6b50", 
            "count" : NumberInt(7), 
            "_id" : ObjectId("628e051b7b7995234486c7a3")
        }, 
        {
            "productName" : "Jabłka", 
            "seller_id" : "628dfbb36387e5c9a32b6b50", 
            "count" : NumberInt(8), 
            "_id" : ObjectId("628e052c7b7995234486c7a5")
        }, 
        {
            "productName" : "Wiśnie", 
            "seller_id" : "628dfb4b6387e5c9a32b6b49", 
            "count" : NumberInt(10), 
            "_id" : ObjectId("628e05cd7b7995234486c7ab")
        }, 
        {
            "productName" : "Czereśnie", 
            "seller_id" : "628dfbc36387e5c9a32b6b52", 
            "count" : NumberInt(12), 
            "_id" : ObjectId("628e06397b7995234486c7af")
        }
    ], 
    "price" : NumberInt(4956), 
    "createdAt" : ISODate("2022-05-25T11:11:58.891+0000"), 
    "updatedAt" : ISODate("2022-05-25T11:11:58.891+0000"), 
    "__v" : NumberInt(0)
}
~~~
